...
grails.project.dependency.resolution = {
    ...
    plugins {
        ...
        if (appName == "risk-analytics-pc-cashflow") {
            ...
            runtime("org.pillarone:risk-analytics-commons:2.0.0-SNAPSHOT") { transitive = false }
            runtime("org.pillarone:risk-analytics-property-casualty:2.0.0-SNAPSHOT") { transitive = false }
        }
    }
